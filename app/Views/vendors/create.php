...
<div class="row">
    <div class="col-12">
          <form action="<?= site_url('vendor/create-vendor'); ?>" method="POST" accept-charset="UTF-8">
            <?= csrf_field() ?>
            <div class="row">
                <div class="col-lg-6">
                  <div class="mb-4">
                    <label for="name" class="form-label fw-semibold">Vendor name *</label>
                    <input type="text" class="form-control" id="name" name="name" required placeholder="Vendor name">
                  </div>
                  <div class="mb-4">
                  ...
                  <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="contactPerson" name="contactPerson" required placeholder="Contact person name">
                  </div>
                  <div class="mb-4">
                    <label for="contactPersonPhone" class="form-label fw-semibold">Contact person phone</label>
                    <input type="text" class="form-control" id="contactPersonPhone" name="contactPersonPhone" placeholder="Contact person phone">
                  </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-4">
                ...
                <div class="col-lg-12">
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" name="notes" id="notes" rows="3" placeholder="Enter notes here..."></textarea>
                    </div>
                </div>
                <div class="col-12">

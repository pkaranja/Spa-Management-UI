...
<?php $daysSelected = explode( ",", $data->daysOffered); ?>

<div class="row">
  <div class="col-12">
    <?= view('App\Views\auth\components\notifications') ?>
    <form action="<?= site_url('package/update/'.$data->id ); ?>" method="POST" accept-charset="UTF-8">
      <?= csrf_field() ?>
      <div class="row">
        <div class="col-lg-6">
          <div class="mb-4">
            <label for="packagename" class="form-label fw-semibold">Package name *</label>
            <input type="text" class="form-control" id="packagename" name="packagename" required placeholder="Package name" value="<?= $data->packageName ?>">
          </div>
          <div class="mb-4">
            <label for="starttime" class="form-label fw-semibold">Start Time *</label>
            <input type="time" class="form-control" id="starttime" name="starttime" required placeholder="Package start time" value="<?= $data->serviceStartTime ?>">
          </div>
          <div class="mb-4">
        ...
        <div class="col-lg-6">
          <div class="mb-4">
              ...
              <input type="number" class="form-control" id="price" name="price" required placeholder="Price" value="<?= $data->cost ?>">
            </div>
            <div class="mb-4">
              <label for="endtime" class="form-label fw-semibold">End Time *</label>
              <input type="time" class="form-control" id="endtime" name="endtime" required placeholder="Package end time" value="<?= $data->serviceEndTime ?>">
            </div>
            <div class="mb-4">
